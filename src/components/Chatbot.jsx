        ...
        <div className="chat enter">
          {isChatTab ? (
            <div className="header">
              ...
              <span className="title" >ACT Appraisal</span>
          ...
          {!isChatTab ? (
            <>
              <ul className="messages-two">
                ...
                <a href="https://actappraisal.com/services/" target="_blank" rel="noopener noreferrer">
                  <li>
                    🎓 Services
                    <Services />
                  </li>
                </a>
                <a href="https://actappraisal.com/helpful-links/" target="_blank" rel="noopener noreferrer">
                  <li>
                    🎉 Resources
                    <Resources />
                  </li>
                </a>
                <a href="https://actappraisal.com/contact/" target="_blank" rel="noopener noreferrer">
                  <li>
                    💬 Contact us
                    <Contact />
                  </li>
