...
function Message() {
  ...
  const handleButtonClick = (buttonText) => {
    ...
    const buttonResponses = {
      "Appraisal Management": "I want to know about Appraisal Management.",
      "Quality Control": "I want to know about Quality Control.",
      "Appraisal Ordering": "I want to know about Appraisal Ordering.",
      "Appraisal Tracking": "I want to know about Appraisal Tracking.",
      "Call First Program": "I want to know about Call First Program.",
      "System Integration": "I want to know about System Integration."
    };
  ...
  useEffect(() => {
    const fetchGreetingMessage = async () => {
      try {
        const data = "Hey there! I’m your virtual assistant at ACT Appraisal. How are you today?😊";
